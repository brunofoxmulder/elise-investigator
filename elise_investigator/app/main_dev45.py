...
from memory_worker_dev45 import TargetedConsciousMemoryWorker

VERSION = "0.2.0-dev.45"
CONSCIOUS_MEMORY_FILE = dev38.CONSCIOUS_MEMORY_FILE


def configure_dev45() -> None:
    ...
    dev34._MEMORY_CARD = dev34._MEMORY_CARD.replace(
        "Mémoire consciente · dev.38", "Mémoire consciente · dev.45"
    )
...
async def create_app() -> web.Application:
    ...
    if isinstance(worker, (TargetedConsciousMemoryWorker, Dev44TargetedConsciousMemoryWorker)):
