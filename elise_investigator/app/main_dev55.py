...
import main_dev54 as dev54
from memory_worker_dev55 import TargetedConsciousMemoryWorker

VERSION = "0.2.0-dev.55"
CONSCIOUS_MEMORY_FILE = dev54.CONSCIOUS_MEMORY_FILE


def configure_dev55() -> None:
    """Promote the native-HA-first path without altering the dev.54 fallback."""
    dev54.configure_dev54()
    ...
    dev34._MEMORY_CARD = dev34._MEMORY_CARD.replace(
        "Mémoire consciente · dev.54", "Mémoire consciente · dev.55"
    )
