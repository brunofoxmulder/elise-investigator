...
from activity_reader_dev62 import ActivityTraceReader
...
async def _activity_payload(app: web.Application, req) -> dict[str, Any]:
    ...
    reader: ActivityTraceReader = app["activity_reader_dev62"]
    ...
    if record is None:
        return {
            ...
            "cause_found": False,
            "result_source": "ha_logbook_empty",
            "read_only": True,
            "version": VERSION,
        }
    ...
    return {
        ...
        "answer_text": answer,
        "cause_found": found,
        "result_source": "ha_logbook_trace",
...
async def create_app() -> web.Application:
    ...
    app["activity_reader_dev62"] = reader
    return app
