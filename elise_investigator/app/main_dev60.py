...
async def _activity_payload(app: web.Application, req) -> dict[str, Any]:
    ...
    reader: ActivityFirstReader = app["activity_reader_dev60"]
    ...
    if record is None:
        return {
            ...
            "cause_found": False,
            "result_source": "ha_activity_empty",
            "read_only": True,
            "version": VERSION,
        }
    ...
    return {
        ...
        "answer_text": answer,
        "cause_found": found,
        "result_source": "ha_activity_native",
...
async def create_app() -> web.Application:
    ...
    reader = ActivityFirstReader(app["ha"], app.get("investigator"))
    reader.set_mcp_client(app.get("mcp"))
    app["activity_reader_dev60"] = reader
    return app
