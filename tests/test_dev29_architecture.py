...
class TestDev29Architecture(unittest.TestCase):
    def test_candidate_launcher_uses_current_wrapper(self):
        ...
        self.assertTrue(any(name in run_sh for name in ("main_dev55.py", "main_dev56.py", "main_dev57.py", "main_dev58.py", "main_dev59.py", "main_dev60.py", "main_dev61.py")))
    ...
    def test_causal_modules_never_call_supervisor_write_endpoints(self):
        names = (
            "activity_reader_dev59.py", "activity_reader_dev60.py", "activity_reader_dev61.py", "causal_enricher.py", "causal_events.py", "causal_recorder.py", "causal_recorder_dev33.py",
            ...
            "main_dev57.py", "main_dev58.py", "main_dev59.py", "main_dev60.py", "main_dev61.py", "memory_response_dev34.py", "memory_worker_dev34.py", "memory_worker_dev36.py",
