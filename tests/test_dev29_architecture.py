...
class TestDev29Architecture(unittest.TestCase):
    ...
    def test_causal_modules_never_call_supervisor_write_endpoints(self):
        names = (
            "activity_reader_dev59.py", "activity_reader_dev60.py", "activity_reader_dev61.py", "activity_reader_dev62.py", "branch_decision_cause_dev62.py", "causal_enricher.py", "causal_events.py", "causal_recorder.py", "causal_recorder_dev33.py",
            ...
            "main_dev57.py", "main_dev58.py", "main_dev59.py", "main_dev60.py", "main_dev61.py", "main_dev62.py", "memory_response_dev34.py", "memory_worker_dev34.py", "memory_worker_dev36.py",
            ...
            "request_journal_dev34.py", "runtime_decision.py", "targeted_memory_enricher_dev36.py", "targeted_memory_enricher_dev62.py",
