...
class Dev69TerrainContractTests(unittest.TestCase):
    ...
    def test_packaging_remains_the_terrain_proven_dev62_contract(self):
        ...
        supported = (
            ...
            "main_v2_rc4.py", "main_v2_rc5.py", "main_v2_rc6.py", "main_v2_rc7.py",
            "main_v2_rc8.py", "main_v2_rc9.py", "main_v2_rc10.py", "main_v2_rc11.py", "main_v2_rc12.py", "main_v2_rc13.py", "main_v2_rc14.py",
        )
