...
class TestDev55Architecture(unittest.TestCase):
    ...
    def test_runtime_keeps_dev55_or_layers_newer_wrapper_above_it(self):
        ...
        self.assertTrue(any(name in run_sh for name in ("main_dev55.py", "main_dev56.py", "main_dev57.py", "main_dev58.py", "main_dev59.py", "main_dev60.py", "main_dev61.py", "main_dev62.py", "main_dev63.py", "main_dev64.py", "main_dev65.py", "main_dev66.py", "main_dev67.py", "main_dev68.py", "main_dev69.py", "main_dev70.py", "main_dev71.py", "main_dev72.py")))
