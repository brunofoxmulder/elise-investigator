...
Manifest public minimal pour tester la candidate privée `0.2.0-dev.12` sous Home Assistant OS.

- Aucun code Python de la 0.2 n'est publié dans ce dossier.
- L'application utilise l'image privée `ghcr.io/brunofoxmulder/elise-investigator-private:0.2.0-dev.12`.
